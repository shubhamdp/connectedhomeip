...
#define GENERATED_ATTRIBUTE_COUNT 78
...
#define GENERATED_CLUSTERS                                                                                                         \
    {                                                                                                                              \
        { 0x001D, ZAP_ATTRIBUTE_INDEX(0), 5, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Descriptor (server) */  \
            ...
            {                                                                                                                      \
                0x0029, ZAP_ATTRIBUTE_INDEX(17), 0, 0, ZAP_CLUSTER_MASK(CLIENT), NULL                                              \
            }, /* Endpoint: 0, Cluster: OTA Software Update Provider (client) */                                                   \
            {                                                                                                                      \
                0x0029, ZAP_ATTRIBUTE_INDEX(17), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                              \
            }, /* Endpoint: 0, Cluster: OTA Software Update Provider (server) */                                                   \
            {                                                                                                                      \
            ...
            {                                                                                                                      \
                0x0034, ZAP_ATTRIBUTE_INDEX(35), 3, 14, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 0, Cluster: Software Diagnostics (server) */                                                           \
            {                                                                                                                      \
                0x0036, ZAP_ATTRIBUTE_INDEX(38), 15, 58, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 0, Cluster: WiFi Network Diagnostics (server) */                                                       \
            {                                                                                                                      \
                0x0037, ZAP_ATTRIBUTE_INDEX(53), 11, 57, ZAP_CLUSTER_MASK(SERVER), NULL                                            \
            }, /* Endpoint: 0, Cluster: Ethernet Network Diagnostics (server) */                                                   \
            {                                                                                                                      \
                0x003C, ZAP_ATTRIBUTE_INDEX(64), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL                                              \
            }, /* Endpoint: 0, Cluster: AdministratorCommissioning (server) */                                                     \
            {                                                                                                                      \
                0x003E, ZAP_ATTRIBUTE_INDEX(65), 6, 4, ZAP_CLUSTER_MASK(SERVER), NULL                                              \
            }, /* Endpoint: 0, Cluster: Operational Credentials (server) */                                                        \
            { 0x0006,                                                                                                              \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 13, 676 }, { ZAP_CLUSTER_INDEX(13), 2, 3 },                                                        \
    }
