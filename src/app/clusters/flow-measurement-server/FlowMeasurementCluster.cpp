...
FlowMeasurementCluster::FlowMeasurementCluster(EndpointId endpointId, const Config & config) :
    MeasurementClusterBase(endpointId,
                           CommonConfig{
                               .optionalAttributeSet = config.mOptionalAttributeSet,
                               .tolerance            = config.mTolerance,
                           },
                           config.minMeasuredValue, config.maxMeasuredValue)
{}
